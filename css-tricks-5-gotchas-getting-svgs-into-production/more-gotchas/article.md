...
![Strokes VS Fills](./images/strokes-vs-fills.jpg "Strokes VS Fills"){:style="float: right;margin-right: 7px;margin-top: 7px;"}
...
```
![Strokes on the Pixel Grid](./images/pixel-view.png "Strokes on the Pixel Grid"){:style="float:right; max-width:300px;"}
