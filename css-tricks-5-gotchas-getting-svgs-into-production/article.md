...
![Creating SVG With Fill Only](./images/export-fill-only.png "Creating SVG With Fill Only")
...
![Creating SVG With Stroke Only](./images/stroke-fill-only.png "Creating SVG With Stroke Only")
